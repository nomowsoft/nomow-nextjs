            ...
            <div className="container mx-auto">
                ...
                <div className="text-center mb-24" data-aos="fade-down">
                    <div className="inline-flex items-center gap-3 mb-4">
                        ...
                        <h1 className="text-4xl xl:text-5xl 2xl:text-6xl font-bold bg-gradient-to-r from-secondary via-primary to-secondary bg-clip-text text-transparent">
                            {t("title")}
                        </h1>
                        <Users className="w-10 h-10 text-primary" />
                    </div>
                        ...
                        {getOurClients?.map((par) => (
                            <SwiperSlide key={par.id}>
                                <div className="py-8">
                                    ...
                                    <div className="group relative bg-white/90 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-3 hover:border-primary/30">
                                        ...
                                        <div className="relative z-10 p-8 flex justify-center items-center min-h-[200px]">
                                            <div className="relative">
                                                ...
                                                <Image
                                                    ...
                                                    width={200}
                                                    height={120}
                                                    className="relative z-10 h-24 w-auto object-contain drop-shadow-lg group-hover:scale-110 transition-transform duration-700 filter grayscale group-hover:grayscale-0"
                                                />
                                            </div>
                                        </div>
